...
EXPECTED_RUNTIME_IMAGE_DIGEST = "sha256:a0b0bea3d2e007ea1bd83fc221eafad1901989130762260b98024e49bbbffb7e"
EXPECTED_RUNTIME_IMAGE_REVISION = "be80aefb7e76d21fad021c8ab5e0f3a869db58a2"
...
def main() -> int:
    if shutil.which("docker") is None:
        ...
        return 1
    image = os.environ.get("PLANE_G4_RUNTIME_IMAGE", "plane-agent-runtime:hermes-e573a466-g4-be80aef")
