...
EXPECTED_RUNTIME_IMAGE_DIGEST = "sha256:b1ab76534def5111e96f3daa62c159bfd7739c854a2e1d8baf649b0757b8ee3f"
EXPECTED_RUNTIME_IMAGE_REVISION = "879c6795e498952d50443d45a621ffa6da9711a7"
...
def main() -> int:
    if shutil.which("docker") is None:
        ...
        return 1
    image = os.environ.get("PLANE_G4_RUNTIME_IMAGE", "plane-agent-runtime:hermes-114eabf9-g4-879c679")
