...
EXPECTED_RUNTIME_IMAGE_DIGEST = "sha256:95dd1d9293517ab52aa68051489f330303b2bd86313d5516c88a107e0d3b3e9d"
EXPECTED_RUNTIME_IMAGE_REVISION = "0f974c7117983116e5bbbf8c746a0b59eb246919"
...
def main() -> int:
    if shutil.which("docker") is None:
        ...
        return 1
    image = os.environ.get("PLANE_G4_RUNTIME_IMAGE", "plane-agent-runtime:hermes-e573a466-g4-0f974c7")
