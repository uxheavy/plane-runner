...
| Item               | Value                                                          |
| ------------------ | -------------------------------------------------------------- |
| Phase              | M8 non-UI region and visual fallback                           |
...
| Next milestone     | Add privacy-safe visual fallback infrastructure                |
...
1. Map existing screenshot, canvas, asset, and redaction primitives.
2. Define snapshot capture ownership without adding presentation UI.
3. Add denied-surface and exact-region privacy tests.
4. Keep semantic references attached separately from visual evidence.
