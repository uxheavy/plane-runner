...
### Current provider-free integration refreeze (2026-08-17)

The named integration branch currently carries source candidate
`ef014eac67323f91c02c73bc9e0ab38e083c1460`. Its exact API artifact is
`plane-agent-api:g4-v13-ef014eac6` at
...
search-result-to-read handoff with target-digest correlation, Code Mode,
authorized read/mutation, exact `NOT_AUTHORIZED`, one outcome submission, one
applied publication, transcript-only ordinary text, idempotency replay, and
late post-publication terminal completion. The final metadata wrapper is
the sole child of the approved source parent; the separately authorized live
provider-backed W07/W08 run
remains outstanding.
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Delivery candidate | Exact provider-free source `ef014eac67323f91c02c73bc9e0ab38e083c1460`; its final candidate is the sole metadata-wrapper child; API `plane-agent-api:g4-v13-ef014eac6` / `sha256:424f75846d398d7e9256933617dcecb685d65c40b059033dd9f378c594a9774e`; runtime `plane-agent-runtime:hermes-6c460f10-g4-v13-ef014eac6` / `sha256:ede43c620b231998391e1878f2d18a28c53e10f9b3f06320b86b65b953a9dfed`; Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. Exact-image red-team and focused search-to-read/authorized-read/denial regressions are green provider-free; the live W07/W08 run remains pending. |
...
| Final verification | Provider-free exact image, bootstrap, contract, manifest, and cleanup checks are green; the final wrapper is the sole child of source `ef014eac67323f91c02c73bc9e0ab38e083c1460`. Pending one full G4 verifier, one consolidated Sol Medium review, and separately authorized live provider-backed W07/W08 proof. |
...
| G4 offline candidate                | Sol P1 closure remains offline-only. The current source candidate is `ef014eac67323f91c02c73bc9e0ab38e083c1460` with API `plane-agent-api:g4-v13-ef014eac6` / `sha256:424f75846d398d7e9256933617dcecb685d65c40b059033dd9f378c594a9774e` and runtime `plane-agent-runtime:hermes-6c460f10-g4-v13-ef014eac6` / `sha256:ede43c620b231998391e1878f2d18a28c53e10f9b3f06320b86b65b953a9dfed`, all bound to Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, and SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. Accepted G3 baseline remains `7c9d35f4c324865c27c84da5016be2c84e460bcc`; no live acceptance is claimed. |
