...
candidate. This is implementation/provenance closure, not live acceptance;
the remaining risk is a fresh live G4 after the same Sol review.
...
| G4 offline baseline  | The previously accepted canonical exact-single-child wrapper remains the baseline; the current P1 remediation is the one-source-commit/one-metadata-wrapper candidate rooted at `d42161bb29bf28f04246b96051cee3a88dcccd36`. The rebuilt API artifact is `plane-agent-api:g4-99b8ba8` / `sha256:0c87ef0b8394a40cabbc8197e58a6fd8079ac056b451104c248d3cafae3a6656`; the rebuilt runtime artifact is `plane-agent-runtime:hermes-d2e65510-g4-codex-fix` / `sha256:826cc9813bd4d7ab562e2bd701bea7c9c9623cd9d19e5f37bee91ca65e5ba35a`. Both are source-bound to Plane `99b8ba8e62a1e2311a7a0c145045c20d314f40c3` and Hermes `d2e655101f263329359e7d0de9d0b856202a3e4b`. Accepted G3 baseline remains `7c9d35f4c324865c27c84da5016be2c84e460bcc`; no live acceptance is claimed.                                                                                                                                                                                                                                                    |
| Current HEAD         | The current source commit is `99b8ba8e62a1e2311a7a0c145045c20d314f40c3`, with one final metadata wrapper child. Sol P1 closure reuses the existing narrow Hermes adapter owner, maps the typed Codex wire to `/backend-api/codex` + `codex_responses`, preserves XAI, rejects provider/host/path/mode mismatches, and proves the child path over bounded UDS in the exact image. It does not create a second agent framework or UI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Live G4 / G5         | The latest authorized live G4 attempt reached Plane's invocation boundary, but its short-lived runner removed the evidence before the provider attempt could be reconciled. The attempt is therefore permanently `outcome_unknown`: an upstream request cannot be excluded and must not be blindly replayed. The retained blocked-canary receipt SHA-256 is `20be555eb93cac98a53ea3c0be1f56d3b6642179b77d9b6acf76ffd23dc76c7a`; a replacement requires a fresh explicit authority and a fresh run, never replay of that attempt. The P1 closure was offline-only and made no retry or external provider request. Live G4 remains unaccepted until that fresh run after the same Sol review; staged G5 remains incomplete and may not be marked complete here.                                                                                                                                                                                                                                                                 |
