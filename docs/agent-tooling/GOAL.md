...
`d4316b79272254b61d038a65cba6a9860a6afeeb`. Its exact API artifact is
`plane-agent-api:g4-v14-d4316b79` at
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Delivery candidate | Exact provider-free source `d4316b79272254b61d038a65cba6a9860a6afeeb`; its final candidate is the sole metadata-wrapper child; API `plane-agent-api:g4-v14-d4316b79` / `sha256:fcd65d1f8fc88b4230ef58370e80d9fd613d7c83fa033cb8bd08f60a68f51422`; runtime `plane-agent-runtime:hermes-6c460f10-g4-v14-d4316b79` / `sha256:00ccc365bf07da61ab1ec24ba307d4e2659fb2dffaff2ce53f8a76f4a64ec139`; Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. Exact-image red-team and focused authorized/denied targetDigest, search-to-read, and idempotency/publication regressions are green provider-free; raw work-item IDs are absent; the live W07/W08 run remains pending. |
...
| Final verification | Provider-free exact image, bootstrap, targetDigest contract, manifest, and cleanup checks are green; the final wrapper is the sole child of source `d4316b79272254b61d038a65cba6a9860a6afeeb`. Pending one full G4 verifier, one consolidated Sol Medium review, and separately authorized live provider-backed W07/W08 proof. |
...
| G4 offline candidate                | Sol P1 closure remains offline-only. The current source candidate is `d4316b79272254b61d038a65cba6a9860a6afeeb` with API `plane-agent-api:g4-v14-d4316b79` / `sha256:fcd65d1f8fc88b4230ef58370e80d9fd613d7c83fa033cb8bd08f60a68f51422` and runtime `plane-agent-runtime:hermes-6c460f10-g4-v14-d4316b79` / `sha256:00ccc365bf07da61ab1ec24ba307d4e2659fb2dffaff2ce53f8a76f4a64ec139`, all bound to Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, and SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. Accepted G3 baseline remains `7c9d35f4c324865c27c84da5016be2c84e460bcc`; no live acceptance is claimed. |
