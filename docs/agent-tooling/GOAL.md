...
| Implementation       | In progress. L1 remains integrated through `0cff5deb8e5488673b39357ae0069fb24c9d6c91`; accepted L2 `88335c5990d6250a29d64977f6cdf4b01dbbd4b0` and L3 `9a0676a99f` are integrated in candidate `6983b968c4` (staging merges `68a3237cb08643f140348c8d1a895435af2756bb` and `9383663dadd01db7946a52f41577fb3de09f9672`). L3 migrations are one proven `0122 -> 0123 -> 0124 -> 0125 -> 0126 -> 0127 -> 0128 -> 0129` chain; fresh PostgreSQL forward migration, two `0129 <-> 0128` reverse/reapply cycles, `showmigrations`, and a direct graph-leaf check passed. The backend-only `test_combined_g1_plane_lifecycle_and_gateway_contract` passed through the prebuilt API image with fresh PostgreSQL (`G1_DIRECT_HARNESS_OK`), and the generated runtime schemas passed their clean check. Full pytest/unit/contract execution and role-separated production-ACL reruns remain open because the available image lacks pytest, the worktree has no dependencies, and installing them is out of scope. L4 (Hermes runtime adapter) remains integrated on Hermes `main` at `c8a693f5300ecb5e348dd0e23ba259c86a266ee1`. |
