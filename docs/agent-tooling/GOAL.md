...
`2d349c29353fc80dc0ef181cea9736b9eef8e829`. Its exact API artifact is
`plane-agent-api:g4-v15-2d349c29` at
...
idempotency replay, and late post-publication terminal completion. The final metadata wrapper is
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Delivery candidate | Exact shared provider-free source `2d349c29353fc80dc0ef181cea9736b9eef8e829`; its final candidate is the sole metadata-wrapper child; API `plane-agent-api:g4-v15-2d349c29` / `sha256:fa5aa7aabe13aa528bb15a4c10effb69c40ed98c88de88d795f23acce88f3ab1`; runtime `plane-agent-runtime:hermes-6c460f10-g4-v15-2d349c29` / `sha256:4f1d52367fb2175e23a9e8c278f5a3edf2795bce99cd698cca6db5194182f559`; Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. The source includes W03/W04 Code Mode route presentation, Operator O01/O03-O09 scope, Manager readiness evidence, and current bounded authority-window generation. Exact-image red-team and focused authorized/denied targetDigest, search-to-read, and idempotency/publication regressions are green provider-free; raw work-item IDs are absent; serialized live lanes remain pending. |
...
| Final verification | Provider-free exact image, bootstrap, targetDigest contract, authority-window regression, manifest, and cleanup checks are green; the final wrapper is the sole child of source `2d349c29353fc80dc0ef181cea9736b9eef8e829`. Pending separately authorized serialized live proofs and one consolidated Sol Medium review. |
...
| G4 offline candidate                | Sol P1 closure remains offline-only. The current shared source candidate is `2d349c29353fc80dc0ef181cea9736b9eef8e829` with API `plane-agent-api:g4-v15-2d349c29` / `sha256:fa5aa7aabe13aa528bb15a4c10effb69c40ed98c88de88d795f23acce88f3ab1` and runtime `plane-agent-runtime:hermes-6c460f10-g4-v15-2d349c29` / `sha256:4f1d52367fb2175e23a9e8c278f5a3edf2795bce99cd698cca6db5194182f559`, all bound to Hermes `6c460f10fe215718dce36dd73cda94155a9a34f8`, MCP `c04974ed6624f17b41e63ef8182661929e77e0d3`, and SDK `7d2faf3b7ef5409e292ba0a3c7015e59f93c5889`. Accepted G3 baseline remains `7c9d35f4c324865c27c84da5016be2c84e460bcc`; no live acceptance is claimed. |
