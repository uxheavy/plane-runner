...
| G4 offline baseline   | Independently accepted at wrapper commit `71a81a66ad8abf7650a8d5550e689df9fc1a86a4`, parent `49db4fd72e944633beb9039b3908598a156254b2`. The exact binding and full offline proof are recorded below. |
| Current HEAD          | Plane commit `c7e6338240` integrates the verified local topology at `c55239032e` plus the original-design reuse correction at `c7e6338240`: one shared runtime settings parser, local Compose extending the canonical community runtime service, a fixed canonical community entrypoint, and proof of both the ordinary local stack and explicit agent profile. Because this HEAD is later than the accepted wrapper, it needs a new wrapper/manifest binding and complete offline G4 rerun before it becomes an accepted exact candidate. |
| Live G4 / G5          | Separately authorized live provider/model evaluation remains undone. G5 staged rollout remains undone and unauthorized. Neither may be marked complete here. |
| Source authorization | Codex task `019fc7db-e8bf-7f92-8f2b-b2346e5eeeb8`, 2026-08-04.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |

Durable authorization statement:

> Implementation is authorized to proceed locally. Pilot, production, deployment, and destructive/external actions remain separately gated.
...
| ---------------- | ---------------- |
| Runtime artifact | Image `plane-agent-runtime:hermes-e573a466-g4-ff8cd9c5`; digest `sha256:8bd10066b99077a60e8a1fda7630fd47a1a59da687aac3d87a80704cd34a7741`; runtime revision `ff8cd9c548ae73a587e9caacb960616bd9964e8b`; Hermes `e573a46611e2cb988f1ab43ad34cd8cc3b2cb659`; contract `plane.agent-runtime/v1`. |
| Offline proof | G3 `256/256`; runtime `10/10`; cross-process `14/14`; service `9/9`; exact-image genuine-Hermes red-team `1/1`; load of 128 requests at `40.057 req/s`, p95 `179.757 ms`, `0%` errors; rollback/readback/config pass; zero labeled resources. |
