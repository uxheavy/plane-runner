...
| `search_catalog`     | `plane.catalog.search@1`                | Bounded read-only search of the complete supported operation catalog        | New approved discovery name; replaces the generic discovery alias                         |
