...
class GatewayOperationInputSerializer(StrictSerializer):
    ...
    # Plane Agent governance contracts.  These remain generic transport
    # fields; lifecycle services own semantic validation and authorization.
    parent_assignment_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    assignment_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    delegator_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    ...
    budget = serializers.JSONField(required=False, allow_null=True)
    proposer_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    kind = serializers.CharField(max_length=32, required=False, allow_blank=False)
    rationale = serializers.CharField(max_length=4096, required=False, allow_blank=False)
    subject_actor_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    subject_user_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    requested_principal_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    target_assignment_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    requested_assignee_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    requested_role = serializers.CharField(max_length=32, required=False, allow_blank=False)
    requested_display_name = serializers.CharField(max_length=255, required=False, allow_blank=True)
    requested_profile = serializers.JSONField(required=False, allow_null=True)
    proposal_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    approved = serializers.BooleanField(required=False)
    decision_note = serializers.CharField(max_length=4096, required=False, allow_blank=True)
    outcome_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    evaluator_ref = serializers.CharField(max_length=128, required=False, allow_blank=False)
    criteria = serializers.JSONField(required=False, allow_null=True)
    verdict = serializers.CharField(max_length=32, required=False, allow_blank=False)
    feedback = serializers.CharField(max_length=4096, required=False, allow_blank=True)
    provenance = serializers.JSONField(required=False, allow_null=True)
